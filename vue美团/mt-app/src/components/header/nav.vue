<template>
  <div class="m-nav">
    <ul class="nav">
      ...
      <li class="list site">
        <router-link to="/">网址导航</router-link>
        <div class="subContainer">
          ...
          <dl class='app'>
            <dt>手机应用</dt>
            <dd>
              <router-link to="/"><img src="//s0.meituan.net/bs/fe-web-meituan/e5eeaef/img/appicons/meituan.png" alt=""></router-link>
            </dd>
            <dd>
              <router-link to="/"><img src="//s1.meituan.net/bs/fe-web-meituan/404d350/img/appicons/waimai.png" alt=""></router-link>
            </dd>
            <dd>
              <router-link to="/"><img src="//s0.meituan.net/bs/fe-web-meituan/404d350/img/appicons/zhenguo.png" alt=""></router-link>
            </dd>
            <dd>
              <router-link to="/"><img src="//s1.meituan.net/bs/fe-web-meituan/404d350/img/appicons/dianping.png" alt=""></router-link>
            </dd>
            <dd>
              <router-link to="/"><img src="//s1.meituan.net/bs/fe-web-meituan/404d350/img/appicons/maoyan.png" alt=""></router-link>
            </dd>
          </dl>
        </div>
      </li>
